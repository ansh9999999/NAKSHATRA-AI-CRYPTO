    ...
    return [
        {
            ...
            'impact': 'EXTREME',
            'effect': 'Crypto effect: volatility can spike sharply. Hawkish surprise → BTC/ETH downside pressure; dovish surprise → upside pressure. Direction is not guaranteed.',
        ...
        },
        {
            ...
            'impact': 'EXTREME',
            'effect': 'Crypto effect: guidance can extend the move after the rate decision. Hawkish tone → risk-off pressure; dovish tone → risk-on pressure. Expect fast BTC/ETH volatility.',
        ...
        },
        {
            ...
            'impact': 'MEDIUM',
            'effect': 'Crypto effect: stronger-than-expected labour data can lift rate expectations and pressure BTC/ETH; weaker data can reduce rate pressure, but recession concerns can also cause risk-off moves.',
        ...
        },
        {
            ...
            'impact': 'HIGH',
            'effect': 'Crypto effect: hot/strong jobs → possible yields/USD rise and BTC/ETH downside pressure; weak jobs → possible dovish/risk-on response, but recession risk can reverse the move.',
        ...
        },
        {
            'name': 'US CPI',
            'impact': 'HIGH',
            'effect': 'Crypto effect: hotter CPI → hawkish rate expectations and possible BTC/ETH downside pressure; cooler CPI → dovish expectations and possible upside pressure. Volatility can spike around release.',
        ...
        },
        {
            'name': 'US PPI',
            'impact': 'HIGH',
            'effect': 'Crypto effect: hotter PPI can increase rate expectations and pressure BTC/ETH; cooler PPI can reduce rate pressure. Market reaction depends on the surprise versus expectations.',
...
def event_context(now_utc: datetime | None = None):
    ...
    variable = [
        {'name': 'Bitcoin ETF flows / regulatory headlines', 'impact': 'HIGH',
         'effect': 'Crypto effect: ETF inflows can support demand/liquidity; outflows can add selling pressure. Regulatory headlines can cause abrupt two-way volatility.',
        ...
        {'name': 'Major exchange / protocol / security news', 'impact': 'HIGH',
         'effect': 'Crypto effect: security/exchange/protocol shocks can create sudden downside risk and liquidity gaps; positive adoption news can improve sentiment. Direction depends on the headline.',
